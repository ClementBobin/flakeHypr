...
in
{
  ...
  config = {
    home.packages = with pkgs; (
      ...
      (lib.optionals (cfg.driver.enable && (lib.elem "chromium" cfg.emulators || lib.elem "chrome" cfg.emulators || lib.elem "vivaldi" cfg.emulators || lib.elem "brave" cfg.emulators)) [chromedriver]) ++
